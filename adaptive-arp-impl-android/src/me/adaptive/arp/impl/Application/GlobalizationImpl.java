package me.adaptive.arp.impl.Application;/*
...
public class GlobalizationImpl implements IGlobalization {
    @Override
    ...
    @Override
    public Map<String, String> getResourceLiterals(Locale locale) {
        return null;
    }
}
