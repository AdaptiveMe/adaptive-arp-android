...
public class GeolocationBridge extends BaseSensorBridge implements IGeolocation, APIBridge {
    ...
    public void addGeolocationListener(IGeolocationListener listener) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing addGeolocationListener({" + listener + "}).");
    ...
    public void removeGeolocationListener(IGeolocationListener listener) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing removeGeolocationListener({" + listener + "}).");
    ...
    public APIResponse invoke(APIRequest request) {
        ...
        switch (request.getMethodName()) {
            ...
            default:
                // 404 - response null.
                responseCode = 404;
                responseMessage = "GeolocationBridge does not provide the function '" + request.getMethodName() + "' Please check your client-side API version; should be API version >= v2.0.8.";
        }
