...
public class FileBridge extends BaseDataBridge implements IFile, APIBridge {
    ...
    public boolean canRead(FileDescriptor descriptor) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing canRead({" + descriptor + "}).");
    ...
    public boolean canWrite(FileDescriptor descriptor) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing canWrite({" + descriptor + "}).");
    ...
    public void create(FileDescriptor descriptor, IFileResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing create({" + descriptor + "},{" + callback + "}).");
    ...
    public boolean delete(FileDescriptor descriptor, boolean cascade) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing delete({" + descriptor + "},{" + cascade + "}).");
    ...
    public boolean exists(FileDescriptor descriptor) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing exists({" + descriptor + "}).");
    ...
    public void getContent(FileDescriptor descriptor, IFileDataLoadResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing getContent({" + descriptor + "},{" + callback + "}).");
    ...
    public IFileSystemStorageType getFileStorageType(FileDescriptor descriptor) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing getFileStorageType({" + descriptor + "}).");
    ...
    public IFileSystemType getFileType(FileDescriptor descriptor) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing getFileType({" + descriptor + "}).");
    ...
    public IFileSystemSecurity getSecurityType(FileDescriptor descriptor) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing getSecurityType({" + descriptor + "}).");
    ...
    public boolean isDirectory(FileDescriptor descriptor) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing isDirectory({" + descriptor + "}).");
    ...
    public void listFiles(FileDescriptor descriptor, IFileListResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing listFiles({" + descriptor + "},{" + callback + "}).");
    ...
    public void listFilesForRegex(FileDescriptor descriptor, String regex, IFileListResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing listFilesForRegex({" + descriptor + "},{" + regex + "},{" + callback + "}).");
    ...
    public boolean mkDir(FileDescriptor descriptor, boolean recursive) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing mkDir({" + descriptor + "},{" + recursive + "}).");
    ...
    public void move(FileDescriptor source, FileDescriptor destination, boolean createPath, boolean overwrite, IFileResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing move({" + source + "},{" + destination + "},{" + createPath + "},{" + overwrite + "},{" + callback + "}).");
    ...
    public void setContent(FileDescriptor descriptor, byte[] content, IFileDataStoreResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing setContent({" + descriptor + "},{" + content + "},{" + callback + "}).");
    ...
    public APIResponse invoke(APIRequest request) {
        ...
        switch (request.getMethodName()) {
            ...
            default:
                // 404 - response null.
                responseCode = 404;
                responseMessage = "FileBridge does not provide the function '" + request.getMethodName() + "' Please check your client-side API version; should be API version >= v2.0.8.";
        }
