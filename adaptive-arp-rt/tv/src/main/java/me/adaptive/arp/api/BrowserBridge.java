...
public class BrowserBridge extends BaseUIBridge implements IBrowser, APIBridge {
    ...
    public boolean openExtenalBrowser(String url) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing openExtenalBrowser({" + url + "}).");
    ...
    public boolean openInternalBrowser(String url, String title, String backButtonText) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing openInternalBrowser({" + url + "},{" + title + "},{" + backButtonText + "}).");
    ...
    public boolean openInternalBrowserModal(String url, String title, String backButtonText) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing openInternalBrowserModal({" + url + "},{" + title + "},{" + backButtonText + "}).");
