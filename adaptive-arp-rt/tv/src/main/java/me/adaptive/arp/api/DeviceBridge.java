...
public class DeviceBridge extends BaseSystemBridge implements IDevice, APIBridge {
    ...
    public void addButtonListener(IButtonListener listener) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing addButtonListener({" + listener + "}).");
    ...
    public void addDeviceOrientationListener(IDeviceOrientationListener listener) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing addDeviceOrientationListener({" + listener + "}).");
    ...
    public void removeButtonListener(IButtonListener listener) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing removeButtonListener({" + listener + "}).");
    ...
    public void removeDeviceOrientationListener(IDeviceOrientationListener listener) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing removeDeviceOrientationListener({" + listener + "}).");
    ...
    public APIResponse invoke(APIRequest request) {
        ...
        switch (request.getMethodName()) {
            ...
            default:
                // 404 - response null.
                responseCode = 404;
                responseMessage = "DeviceBridge does not provide the function '" + request.getMethodName() + "' Please check your client-side API version; should be API version >= v2.0.8.";
        }
