...
public class ContactBridge extends BasePIMBridge implements IContact, APIBridge {
    ...
    public void getContact(ContactUid contact, IContactResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing getContact({" + contact + "},{" + callback + "}).");
    ...
    public void getContactPhoto(ContactUid contact, IContactPhotoResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing getContactPhoto({" + contact + "},{" + callback + "}).");
    ...
    public void getContacts(IContactResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing getContacts({" + callback + "}).");
    ...
    public void getContactsForFields(IContactResultCallback callback, IContactFieldGroup[] fields) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing getContactsForFields({" + callback + "},{" + fields + "}).");
    ...
    public void getContactsWithFilter(IContactResultCallback callback, IContactFieldGroup[] fields, IContactFilter[] filter) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing getContactsWithFilter({" + callback + "},{" + fields + "},{" + filter + "}).");
    ...
    public void searchContacts(String term, IContactResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing searchContacts({" + term + "},{" + callback + "}).");
    ...
    public void searchContactsWithFilter(String term, IContactResultCallback callback, IContactFilter[] filter) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing searchContactsWithFilter({" + term + "},{" + callback + "},{" + filter + "}).");
    ...
    public boolean setContactPhoto(ContactUid contact, byte[] pngImage) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing setContactPhoto({" + contact + "},{" + pngImage + "}).");
    ...
    public APIResponse invoke(APIRequest request) {
        ...
        switch (request.getMethodName()) {
            ...
            default:
                // 404 - response null.
                responseCode = 404;
                responseMessage = "ContactBridge does not provide the function '" + request.getMethodName() + "' Please check your client-side API version; should be API version >= v2.0.8.";
        }
