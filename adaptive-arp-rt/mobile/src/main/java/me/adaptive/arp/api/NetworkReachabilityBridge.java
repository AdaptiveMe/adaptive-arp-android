...
public class NetworkReachabilityBridge extends BaseCommunicationBridge implements INetworkReachability, APIBridge {
    ...
    public void isNetworkReachable(String host, INetworkReachabilityCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing isNetworkReachable({" + host + "},{" + callback + "}).");
    ...
    public void isNetworkServiceReachable(String url, INetworkReachabilityCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing isNetworkServiceReachable({" + url + "},{" + callback + "}).");
