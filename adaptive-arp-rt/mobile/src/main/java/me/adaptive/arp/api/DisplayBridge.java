...
public class DisplayBridge extends BaseSystemBridge implements IDisplay, APIBridge {
    ...
    public void addDisplayOrientationListener(IDisplayOrientationListener listener) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing addDisplayOrientationListener({" + listener + "}).");
    ...
    public void removeDisplayOrientationListener(IDisplayOrientationListener listener) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing removeDisplayOrientationListener({" + listener + "}).");
    ...
    public APIResponse invoke(APIRequest request) {
        ...
        switch (request.getMethodName()) {
            ...
            default:
                // 404 - response null.
                responseCode = 404;
                responseMessage = "DisplayBridge does not provide the function '" + request.getMethodName() + "' Please check your client-side API version; should be API version >= v2.0.8.";
        }
