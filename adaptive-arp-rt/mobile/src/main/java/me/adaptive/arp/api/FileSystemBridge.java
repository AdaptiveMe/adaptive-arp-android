...
public class FileSystemBridge extends BaseDataBridge implements IFileSystem, APIBridge {
    ...
    public FileDescriptor createFileDescriptor(FileDescriptor parent, String name) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing createFileDescriptor({" + parent + "},{" + name + "}).");
    ...
    public APIResponse invoke(APIRequest request) {
        ...
        switch (request.getMethodName()) {
            ...
            default:
                // 404 - response null.
                responseCode = 404;
                responseMessage = "FileSystemBridge does not provide the function '" + request.getMethodName() + "' Please check your client-side API version; should be API version >= v2.0.8.";
        }
