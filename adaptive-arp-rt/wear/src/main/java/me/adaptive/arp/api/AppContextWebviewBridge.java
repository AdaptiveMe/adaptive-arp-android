...
public class AppContextWebviewBridge implements IAppContextWebview {
    ...
    public void addWebview(Object webView) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing addWebview({" + webView + "}).");
    ...
    public void executeJavaScript(String javaScriptText) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing executeJavaScript({" + javaScriptText + "}).");
    ...
    public void executeJavaScript(String javaScriptText, Object webViewReference) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing executeJavaScript({" + javaScriptText + "},{" + webViewReference + "}).");
    ...
    public void removeWebview(Object webView) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing removeWebview({" + webView + "}).");
