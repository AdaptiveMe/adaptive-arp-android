...
public class DatabaseBridge extends BaseDataBridge implements IDatabase, APIBridge {
    ...
    public void createDatabase(Database database, IDatabaseResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing createDatabase({" + database + "},{" + callback + "}).");
    ...
    public void createTable(Database database, DatabaseTable databaseTable, IDatabaseTableResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing createTable({" + database + "},{" + databaseTable + "},{" + callback + "}).");
    ...
    public void deleteDatabase(Database database, IDatabaseResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing deleteDatabase({" + database + "},{" + callback + "}).");
    ...
    public void deleteTable(Database database, DatabaseTable databaseTable, IDatabaseTableResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing deleteTable({" + database + "},{" + databaseTable + "},{" + callback + "}).");
    ...
    public void executeSqlStatement(Database database, String statement, String[] replacements, IDatabaseTableResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing executeSqlStatement({" + database + "},{" + statement + "},{" + replacements + "},{" + callback + "}).");
    ...
    public void executeSqlTransactions(Database database, String[] statements, boolean rollbackFlag, IDatabaseTableResultCallback callback) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing executeSqlTransactions({" + database + "},{" + statements + "},{" + rollbackFlag + "},{" + callback + "}).");
    ...
    public boolean existsDatabase(Database database) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing existsDatabase({" + database + "}).");
    ...
    public boolean existsTable(Database database, DatabaseTable databaseTable) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing existsTable({" + database + "},{" + databaseTable + "}).");
    ...
    public APIResponse invoke(APIRequest request) {
        ...
        switch (request.getMethodName()) {
            ...
            default:
                // 404 - response null.
                responseCode = 404;
                responseMessage = "DatabaseBridge does not provide the function '" + request.getMethodName() + "' Please check your client-side API version; should be API version >= v2.0.8.";
        }
