...
public class CapabilitiesBridge extends BaseSystemBridge implements ICapabilities, APIBridge {
    ...
    public ICapabilitiesOrientation getOrientationDefault() {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing getOrientationDefault.");

        ICapabilitiesOrientation result = null;
        if (this.delegate != null) {
            result = this.delegate.getOrientationDefault();
            if (logger != null)
                logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executed 'getOrientationDefault' in " + (System.currentTimeMillis() - tIn) + "ms.");
        } else {
            if (logger != null)
                logger.log(ILoggingLogLevel.ERROR, this.apiGroup.name(), this.getClass().getSimpleName() + " no delegate for 'getOrientationDefault'.");
        }
        return result;
    }
    ...
    public ICapabilitiesOrientation[] getOrientationsSupported() {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing getOrientationsSupported.");

        ICapabilitiesOrientation[] result = null;
        if (this.delegate != null) {
            result = this.delegate.getOrientationsSupported();
            if (logger != null)
                logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executed 'getOrientationsSupported' in " + (System.currentTimeMillis() - tIn) + "ms.");
        } else {
            if (logger != null)
                logger.log(ILoggingLogLevel.ERROR, this.apiGroup.name(), this.getClass().getSimpleName() + " no delegate for 'getOrientationsSupported'.");
        }
        return result;
    }
    ...
    public boolean hasButtonSupport(ICapabilitiesButton type) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing hasButtonSupport({" + type + "}).");

        boolean result = false;
        if (this.delegate != null) {
            result = this.delegate.hasButtonSupport(type);
            if (logger != null)
                logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executed 'hasButtonSupport' in " + (System.currentTimeMillis() - tIn) + "ms.");
        } else {
            if (logger != null)
                logger.log(ILoggingLogLevel.ERROR, this.apiGroup.name(), this.getClass().getSimpleName() + " no delegate for 'hasButtonSupport'.");
        }
        return result;
    }
    ...
    public boolean hasCommunicationSupport(ICapabilitiesCommunication type) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing hasCommunicationSupport({" + type + "}).");

        boolean result = false;
        if (this.delegate != null) {
            result = this.delegate.hasCommunicationSupport(type);
            if (logger != null)
                logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executed 'hasCommunicationSupport' in " + (System.currentTimeMillis() - tIn) + "ms.");
        } else {
            if (logger != null)
                logger.log(ILoggingLogLevel.ERROR, this.apiGroup.name(), this.getClass().getSimpleName() + " no delegate for 'hasCommunicationSupport'.");
        }
        return result;
    }
    ...
    public boolean hasDataSupport(ICapabilitiesData type) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing hasDataSupport({" + type + "}).");

        boolean result = false;
        if (this.delegate != null) {
            result = this.delegate.hasDataSupport(type);
            if (logger != null)
                logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executed 'hasDataSupport' in " + (System.currentTimeMillis() - tIn) + "ms.");
        } else {
            if (logger != null)
                logger.log(ILoggingLogLevel.ERROR, this.apiGroup.name(), this.getClass().getSimpleName() + " no delegate for 'hasDataSupport'.");
        }
        return result;
    }
    ...
    public boolean hasMediaSupport(ICapabilitiesMedia type) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing hasMediaSupport({" + type + "}).");

        boolean result = false;
        if (this.delegate != null) {
            result = this.delegate.hasMediaSupport(type);
            if (logger != null)
                logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executed 'hasMediaSupport' in " + (System.currentTimeMillis() - tIn) + "ms.");
        } else {
            if (logger != null)
                logger.log(ILoggingLogLevel.ERROR, this.apiGroup.name(), this.getClass().getSimpleName() + " no delegate for 'hasMediaSupport'.");
        }
        return result;
    }
    ...
    public boolean hasNetSupport(ICapabilitiesNet type) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing hasNetSupport({" + type + "}).");

        boolean result = false;
        if (this.delegate != null) {
            result = this.delegate.hasNetSupport(type);
            if (logger != null)
                logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executed 'hasNetSupport' in " + (System.currentTimeMillis() - tIn) + "ms.");
        } else {
            if (logger != null)
                logger.log(ILoggingLogLevel.ERROR, this.apiGroup.name(), this.getClass().getSimpleName() + " no delegate for 'hasNetSupport'.");
        }
        return result;
    }
    ...
    public boolean hasNotificationSupport(ICapabilitiesNotification type) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing hasNotificationSupport({" + type + "}).");

        boolean result = false;
        if (this.delegate != null) {
            result = this.delegate.hasNotificationSupport(type);
            if (logger != null)
                logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executed 'hasNotificationSupport' in " + (System.currentTimeMillis() - tIn) + "ms.");
        } else {
            if (logger != null)
                logger.log(ILoggingLogLevel.ERROR, this.apiGroup.name(), this.getClass().getSimpleName() + " no delegate for 'hasNotificationSupport'.");
        }
        return result;
    }
    ...
    public boolean hasOrientationSupport(ICapabilitiesOrientation orientation) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing hasOrientationSupport({" + orientation + "}).");

        boolean result = false;
        if (this.delegate != null) {
            result = this.delegate.hasOrientationSupport(orientation);
            if (logger != null)
                logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executed 'hasOrientationSupport' in " + (System.currentTimeMillis() - tIn) + "ms.");
        } else {
            if (logger != null)
                logger.log(ILoggingLogLevel.ERROR, this.apiGroup.name(), this.getClass().getSimpleName() + " no delegate for 'hasOrientationSupport'.");
        }
        return result;
    }
    ...
    public boolean hasSensorSupport(ICapabilitiesSensor type) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing hasSensorSupport({" + type + "}).");

        boolean result = false;
        if (this.delegate != null) {
            result = this.delegate.hasSensorSupport(type);
            if (logger != null)
                logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executed 'hasSensorSupport' in " + (System.currentTimeMillis() - tIn) + "ms.");
        } else {
            if (logger != null)
                logger.log(ILoggingLogLevel.ERROR, this.apiGroup.name(), this.getClass().getSimpleName() + " no delegate for 'hasSensorSupport'.");
        }
        return result;
    }
