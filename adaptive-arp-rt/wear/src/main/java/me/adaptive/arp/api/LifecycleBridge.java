...
public class LifecycleBridge extends BaseApplicationBridge implements ILifecycle, APIBridge {
    ...
    public void addLifecycleListener(ILifecycleListener listener) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing addLifecycleListener({" + listener + "}).");
    ...
    public void removeLifecycleListener(ILifecycleListener listener) {
        ...
        if (logger != null)
            logger.log(ILoggingLogLevel.DEBUG, this.apiGroup.name(), this.getClass().getSimpleName() + " executing removeLifecycleListener({" + listener + "}).");
    ...
    public APIResponse invoke(APIRequest request) {
        ...
        switch (request.getMethodName()) {
            ...
            default:
                // 404 - response null.
                responseCode = 404;
                responseMessage = "LifecycleBridge does not provide the function '" + request.getMethodName() + "' Please check your client-side API version; should be API version >= v2.0.8.";
        }
